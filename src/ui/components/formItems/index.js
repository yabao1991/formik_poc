...
export const FormItems = ({ config, formik, stepNum }) => {
      ...
      case 'number':
        return (
          <Padding key={individualConfig.fieldId} bottom={16}>
            ...
            {formik.errors[stepNum] && formik.errors[stepNum][individualConfig.fieldId] && (
              <Field error={formik.errors[stepNum][individualConfig.fieldId]} />
            )}
          </Padding>
        );
      case 'checkbox':
        return (
          <>
            ...
            {individualConfig.fieldId === 'paidVacation' &&
              formik.values.step_03 &&
              formik.values.step_03.paidVacation?.selected && (
            ...
            {formik.errors[stepNum] && [individualConfig.fieldId] && (
              <Field error={formik.errors[stepNum][individualConfig.fieldId]} />
            )}
          </>
        );
        ...
        return (
          <>
            <Padding key={individualConfig.fieldId} bottom={8}>
              {individualConfig.subFields && individualConfig.subFields.map((item, index) => {
                return (
